...
DROP TABLE IF EXISTS prix_crypto CASCADE;
DROP TABLE IF EXISTS transaction_crypto CASCADE;
...
DROP SEQUENCE IF EXISTS crypto_id_crypto_seq CASCADE;
DROP SEQUENCE IF EXISTS prix_crypto_id_prix_seq CASCADE;
DROP SEQUENCE IF EXISTS portefeuille_id_portefeuille_seq CASCADE;
